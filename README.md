...
An account theme with the same styling is provided in `themes/keywind/account`. It extends the built‑in `keycloak` account theme so Keycloak can render the full account console with the Minet look and feel.
